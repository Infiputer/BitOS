...
#define DoubleBufferMainSize 512 //(1920*1080)/4096 = 506.25
class Graphics
{
public:
    ...
    */
    ...
    uint8_t* doubleBufferArrayRED[DoubleBufferMainSize];
    uint8_t* doubleBufferArrayGREEN[DoubleBufferMainSize];
    uint8_t* doubleBufferArrayBLUE[DoubleBufferMainSize];
