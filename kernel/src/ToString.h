...
static char uintTo_StringOutput[128];
...
static const char *to_hstring(uint64_t value)
{
...
static char hexTo_StringOutput32[128];
static const char *to_hstring(uint32_t value)
{
...
static char hexTo_StringOutput16[128];
static const char *to_hstring(uint16_t value)
{
...
static char hexTo_StringOutput8[128];
static const char *to_hstring(uint8_t value)
{
...
static char doubleTo_StringOutput[128];
static const char *to_string(double value, uint8_t decimalPlaces)
{
    if (decimalPlaces > 20)
        decimalPlaces = 20;
